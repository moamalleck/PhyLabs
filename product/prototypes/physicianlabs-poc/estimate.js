...
(function () {
  ...
  // Don't let a page scroll over a slider silently change the prospect's inputs
  // (reads as the tool being unstable in a live screen-share).
  [elVisits, elReimb, elDenial].forEach(function (el) {
